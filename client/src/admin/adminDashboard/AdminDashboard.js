                ...
                <section className='pt-[14px] pb-[14px]  flex justify-evenly'>
                    ...
                    <div className='dashdiv w-[10em] rounded-xl text-white  '>
                        <div className='flex justify-around'>
                            <p className=' text-3xl font-black'>160<br></br> <span className=' font-normal text-sm italic'>parts in stock</span> </p>
                    ...
                    <div className='dashdiv w-[10em] rounded-xl text-white  '>
                        <div className='flex justify-around'>
                            <p className=' text-3xl font-black'>10<br></br> <span className=' font-normal text-sm italic'>clients</span> </p>
                ...
                <section className=' h-[55vh] pt-2 grid grid-cols-3 mb-4 gap-2'>
                    ...
                    <div className=' h-[52vh]'>
                        ...
                        <div className=' rounded-lg dashdiv text-white h-[24vh] mt-2 mr-2 ml-2'>
                            ...
                            <h1 className='pl-1'>Cars sold report</h1>
                            </div>
                        </div>
                    </div>
                </section>
