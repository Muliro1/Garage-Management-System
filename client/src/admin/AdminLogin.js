...
function AdminLogin({setFullName,setPassword, handleLogin, error ,loading}) {
    return (
        <div className='adminlogin h-[100vh]'>
            ...
            <div className=' rounded-lg bg-gradient-to-b from-slate-100 to-transparent via-grey-500 m-auto  w-5/12 mt-10'>
                ...
                <form className=' text-center mt-6 ' onSubmit={(e) => handleLogin(e)}>
                    {error.length > 0 && (
                    ...
                    <input onChange={(e)=>setFullName(e.target.value)} type='text' className='m-2 mb-6 rounded-full p-1 text-center' placeholder='enter username...' required/><br></br>
