        ...
        <div className='mt-6'>
            <div className='flex justify-around bg-slate-300 rounded-lg pt-2 pb-1 mb-2 mr-2 ml-2 '>
                ...
                <div className='grid grid-cols-3'>
                    <svg className='hover:bg-black hover:cursor-pointer col-span-2' onClick={() => setIsOpen(!isOpen)} width="22" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
