...
function AdminSignup({setFullName,setPassword,handleSignup, error ,loading, props}) {
    return (
        <div className='adminlogin h-[100vh]'>
            ...
            <div className=' rounded-lg bg-gradient-to-b from-slate-100 to-transparent via-grey-500 m-auto  w-5/12 mt-10'>
                ...
                <form className=' text-center mt-6 ' onSubmit={(e) => handleSignup(e, setFullName, setPassword, props)}>
                    ...
                    <input type='submit' value="SignUp" className='mt-6 mb-16 bg-black adminloginbtn text-white p-1 rounded-2xl w-3/12 hover:cursor-pointer  hover:ease-in-out duration-300 hover:scale-125 hover:bg-white hover:text-black' />
                </form>
