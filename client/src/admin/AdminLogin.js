        ...
        <div className='adminlogin h-[100vh]'>
            ...
            <div className=' rounded-lg bg-gradient-to-b from-slate-100 to-transparent via-grey-500 m-auto  w-5/12 mt-10'>
                ...
                <form className=' text-center mt-6 '>
                    ...
                    <label className='tracking-wide font-black text-xl  font-serif'>Username</label><br></br>
                    <input type='text' className='m-2 mb-6 rounded-full p-1 text-center' placeholder='enter username...' required/><br></br>

                    <label className='tracking-wide font-black text-xl font-serif' >Password</label><br></br>
                    <input type='password' className='p-1 m-2 mb-6 text-center rounded-full bg-slate-50' placeholder='enter password...' required/><br></br>
