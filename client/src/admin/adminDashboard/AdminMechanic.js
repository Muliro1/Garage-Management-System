        ...
        <div className='mt-10'>
            <div className='flex justify-around bg-slate-300 rounded-lg pt-2 pb-1 mb-2 mr-2 ml-2 '>
                ...
                <div className='flex '>
                    ...
                    <svg  className='ml-2 hover:cursor-pointer' width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
